...
export interface MockERC721Interface extends utils.Interface {
  functions: {
    "_transferFrom(address,address,uint256)": FunctionFragment;
    ...
    "tokenIdPointer()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "tokenIdPointer",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "Minted(uint256,address,string,address)": EventFragment;
...
export type MintedEvent = TypedEvent<
  ...
  { tokenId: BigNumber; beneficiary: string; tokenUri: string; minter: string }
>;
...
export interface MockERC721 extends BaseContract {
  ...
  functions: {
    ...
    tokenIdPointer(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    tokenIdPointer(overrides?: CallOverrides): Promise<PopulatedTransaction>;
