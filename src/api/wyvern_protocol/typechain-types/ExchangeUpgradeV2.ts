...
export interface ExchangeUpgradeV2Interface extends utils.Interface {
  functions: {
...
export interface ExchangeUpgradeV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ExchangeUpgradeV2Interface;
