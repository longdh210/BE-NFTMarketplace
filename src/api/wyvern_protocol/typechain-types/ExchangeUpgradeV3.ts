...
export interface ExchangeUpgradeV3Interface extends utils.Interface {
  functions: {
    "INVERSE_BASIS_POINT()": FunctionFragment;
    "__ExchangeCore_init(uint256,uint256)": FunctionFragment;
    "__Exchange_init()": FunctionFragment;
    "__WyvernExchange_init(address,address,address,address)": FunctionFragment;
    ...
    "createTest(string)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "__WyvernExchange_init",
  ...
  encodeFunctionData(functionFragment: "createTest", values: [string]): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: "testMapping", values: [string]): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "createTest", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "exchangeToken",
    data: BytesLike
  ): Result;
...
export interface ExchangeUpgradeV3 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ExchangeUpgradeV3Interface;
  ...
  functions: {
    ...
    someVariable(overrides?: CallOverrides): Promise<[string]>;
    ...
    testMapping(arg0: string, overrides?: CallOverrides): Promise<[boolean]>;
  ...
  callStatic: {
    ...
    createTest(_name: string, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    someVariable(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    testMapping(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    someVariable(overrides?: CallOverrides): Promise<PopulatedTransaction>;
